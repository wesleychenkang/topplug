...
public class CrashHandler implements UncaughtExceptionHandler {
	...
	public static final String TAG = "CrashHandler";
	    ...
	    private DateFormat formatter = new SimpleDateFormat(  
	            "yyyyMMddHH-mm-ss.SSS", Locale.CHINA);
	    ...
	    private String saveCrashInfoToFile(Throwable ex) {
	        ...
	        try {
	            ...
	            String fromate = formatter.format(date);
	            fileName = fileDir  + fromate
	                    + CRASH_REPORTER_EXTENSION;
	            File file = new File(fileName);
	            if (!file.exists())
	                file.createNewFile();
	            FileOutputStream trace = new FileOutputStream(file);
	            mDeviceCrashInfo.store(new OutputStreamWriter(trace, "UTF-8"), "");
	            trace.flush();
	            trace.close();
	            return fileName;
	        } catch (Exception e) {
